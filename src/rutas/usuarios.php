...
$app->post($prefix.'/registrar', function(Request $request, Response $response){
    ...
    try {
        ...
        echo '{ "status" : "Failed", "message": "No se pudo registrar al usuario", "type_error": "message": "' . $e->getMessage().'"}';
    }
...
$app->post($prefix.'/session/login', function(Request $request, Response $response){
    ...
    $query = "SELECT id_usuario, nombre, correo FROM usuarios WHERE correo = '$email' AND pass = '$pass'";
